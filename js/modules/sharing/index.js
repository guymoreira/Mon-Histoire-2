...
(function() {
  ...
  const sharingModule = MonHistoire.modules.sharing;
  ...
  try {
    ...
    // Cela permet d'y accéder via MonHistoire.modules.sharing.nomDuModule
    
    // 1. Module de notifications
    if (MonHistoire.modules.sharing.notifications) {
      sharingModule.notifications = MonHistoire.modules.sharing.notifications;
    ...
    if (MonHistoire.modules.sharing.storage) {
      sharingModule.storage = MonHistoire.modules.sharing.storage;
    ...
    if (MonHistoire.modules.sharing.ui) {
      sharingModule.ui = MonHistoire.modules.sharing.ui;
    ...
    if (MonHistoire.modules.sharing.realtime) {
      sharingModule.realtime = MonHistoire.modules.sharing.realtime;
