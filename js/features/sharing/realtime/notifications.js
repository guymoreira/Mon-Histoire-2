 ...
 */
MonHistoire.features.sharing.realtime.notifications = {
  /**
  ...
  configurerEcouteurNotificationsRealtime() {
    ...
    try {
      ...
      const connectedListener = connectedRef.on("value", (snap) => {
        ...
        if (isConnected && (!MonHistoire.features.sharing.realtimeListeners || MonHistoire.features.sharing.realtimeListeners.length === 0)) {
