...
const el_mentById("personnage").addEventListener("change", updatePreview) = document.getElementById('mentById("personnage").addEventListener("change", updatePreview)');
if (el_mentById("personnage").addEventListener("change", updatePreview)) { el_mentById("personnage").addEventListener("change", updatePreview).addEventListener('click', handleLogin); }
const el_mentById("lieu").addEventListener("change", updatePreview) = document.getElementById('mentById("lieu").addEventListener("change", updatePreview)');
if (el_mentById("lieu").addEventListener("change", updatePreview)) { el_mentById("lieu").addEventListener("change", updatePreview).addEventListener('click', handleLogin); }
